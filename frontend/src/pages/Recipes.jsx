...
import recipesBg from '../assets/bg3.jpg'
function Recipes() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `linear-gradient(rgba(255,255,255,0.88), rgba(255,255,255,0.88)), url(${recipesBg})` }}
    >
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {recipesLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {recipes.map((recipe) => (
              <div key={recipe.id} className="bg-white/90 dark:bg-gray-800/90 backdrop-blur rounded-2xl shadow-md overflow-hidden hover:shadow-xl hover:-translate-y-1 transition duration-200">
